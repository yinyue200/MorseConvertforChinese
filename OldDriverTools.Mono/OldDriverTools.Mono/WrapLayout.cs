...
// Created          : 12-27-2015
// 
// Last Modified By : yinyue200.com
...
namespace OldDriverTools.Mono
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static readonly BindableProperty SpacingProperty =
            BindableProperty.Create(nameof(Spacing), typeof(double), typeof(WrapLayout), 6d,
                propertyChanged: (bindable, oldvalue, newvalue) => ((WrapLayout)bindable).OnSizeChanged());
        ...
        private SizeRequest DoVerticalMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            foreach (var size in Children.Where(c => c.IsVisible).Select(item => item.Measure(widthConstraint, heightConstraint, MeasureFlags.IncludeMargins)))
            {
        ...
        private SizeRequest DoHorizontalMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            {
                var size = item.Measure(widthConstraint, heightConstraint, MeasureFlags.IncludeMargins);
        ...
        protected override void LayoutChildren(double x, double y, double width, double height)
        {
            if (Orientation == StackOrientation.Vertical)
            {
                ...
                {
                    var request = child.Measure(width, height, MeasureFlags.IncludeMargins);
